...
This project is indexed by CodraGraph as **coaether** (2251 symbols, 6135 relationships, 163 execution flows). Use the CodraGraph MCP tools to understand code, assess impact, and navigate safely.
