import type { Node, Session, CreateSessionReq, Agent, AgentProfile, AgentFolder, FolderItem, RuntimeEntity, Task, CreateTaskReq, UpdateTaskReq, TaskStatus, TaskAssignee, AddAssigneeReq, Priority, Project, CreateProjectReq, UpdateProjectReq, ProjectStatus, Workspace, CreateWorkspaceReq, UpdateWorkspaceReq, WorkspaceMember, AddMemberReq, UpdateMemberRoleReq, PendingInvitation, InviteMemberReq, UserSummary, Comment, CreateCommentReq, AppNotification, TaskRule, TaskRuleLog, CreateRuleReq, UpdateRuleReq, Skill, CreateSkillReq, ExtractSkillReq, AgentQueueItem, AgentLoadInfo, ReviewTaskReq, Workflow, CreateWorkflowReq, AttachToWorkflowReq, DecompositionPlan, DecompositionPlanItem, ApprovePlanReq, SystemTool, ApiToken, CreateTokenReq, CreateTokenRes, AgentToolLogItem, AccessLogItem, TokenUsageItem, SystemEventItem, PaginatedResp } from '../types';
...
export const agentProfiles = {
  ...
  create: (data: { name: string; description?: string; system_prompt?: string; instructions?: string; agent_id: string; node_id?: string; tags?: string[]; max_concurrency?: number; capabilities?: string[]; token_budget?: number }) =>
  ...
  update: (id: string, data: Partial<{ name: string; description: string; system_prompt: string; instructions: string; avatar: string; agent_id: string; node_id: string; enabled: boolean; max_concurrency: number; tags: string[]; skills: string[]; capabilities: string[]; review_sample_rate: number; review_timeout: number; max_review_loops: number; max_depth: number; completion_behavior: string; token_budget: number }>) =>
